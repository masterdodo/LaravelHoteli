...
<h1 class="margin">New Hotel</h1>
<br />

    <div class="create-hotel-div margin">
        ...
        <div class="form-group">
            {!! Form::label('image1', 'Image 2:') !!}
            {!! Form::file('image1', ['class'=>'form-control-file']) !!}
        </div>
        <div class="form-group">
            {!! Form::label('image2', 'Image 3:') !!}
            {!! Form::file('image2', ['class'=>'form-control-file']) !!}
        </div>
        <div class="form-group">
            {!! Form::label('image3', 'Image 4:') !!}
            {!! Form::file('image3', ['class'=>'form-control-file']) !!}
        </div>
        <div class="form-group">
            {!! Form::label('image4', 'Image 5:') !!}
            {!! Form::file('image4', ['class'=>'form-control-file']) !!}
        </div>
